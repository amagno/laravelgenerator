...
{{ Form::model($AtendimentoEmail, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('AtendimentoEmails.update', $AtendimentoEmail->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('AtendimentoEmails.show', 'Cancel', $AtendimentoEmail->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
