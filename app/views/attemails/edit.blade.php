...
{{ Form::model($attemail, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('attemails.update', $attemail->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('attemails.show', 'Cancel', $attemail->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
